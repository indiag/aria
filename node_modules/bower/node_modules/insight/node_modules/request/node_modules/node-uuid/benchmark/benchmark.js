...
try {
  var uuidjs = require('uuid-js_old');
} catch (e) {
  console.error('uuid-js_old require failed - skipping tests');
}
...
if (nodeuuid) {
  ...
  rate('nodeuuid.v4() - using node.js_old crypto RNG', t);
