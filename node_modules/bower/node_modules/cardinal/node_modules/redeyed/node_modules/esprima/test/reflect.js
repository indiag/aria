...
// at js_old/src/tests/js1_8_5/extensions/reflect-parse.js_old in the source tree).
//
...
//program(_).assert(Reflect.parse(snarf('data/prototype.js_old')));
//program(_).assert(Reflect.parse(snarf('data/dojo.js_old.uncompressed.js_old')));
//program(_).assert(Reflect.parse(snarf('data/mootools-1.2.4-core-nc.js_old')));
